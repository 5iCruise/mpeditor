...
- [DEMO on Vercel](https://mpeditor.vercel.app/)
...
- [x] 提供对 [Mermaid](https://mermaid.js.org/intro/getting-started.html) 图表的渲染和 [GFM 警告块](https://github.com/orgs/community/discussions/16925)的支持
- [x] 丰富的代码块高亮主题，提升代码可读性
- [x] 允许自定义主题色和 CSS 样式，灵活定制展示效果
- [x] 提供多图上传功能，并可自定义配置图床
- [x] 便捷的文件导入、导出功能，提升工作效率
- [x] 内置本地内容管理功能，支持草稿自动保存
- [x] 提供 Chrome/Edge/Firefox [浏览器插件](，随时随地保存文章内容，快速生成微信公众号图文
...
### 方式 3. 使用 Vercel 部署（本 repo 方案）


## 感谢

- [Doocs](https://mp.weixin.qq.com/s/RNKDCK2KoyeuMeEs6GUrow)
- [Doocs 技术社区](https://github.com/doocs)
